...
<style>
    :root {
        --vintage-primary: #795548;
        --theme-dark: #3e2723;
        --gold-primary: #c69214;
        --gold-light: #efebe9;
        --gold-accent: #d7ccc8;
        --cream-bg: #faf6f0;
        --card-bg: rgba(253, 248, 237, 0.98);
        --card-shadow: 0 25px 65px rgba(121, 85, 72, 0.2), 0 10px 30px rgba(198, 146, 20, 0.25);
        --text-dark: #271a0c;
        --rose-accent: #c84b68;
    }
    ...
    body.dark-mode {
        --cream-bg: #18110b;
        --card-bg: rgba(44, 31, 21, 0.97);
        --text-dark: #fdf5e6;
        background: radial-gradient(ellipse at 50% 0%, #302014 0%, #1a110a 60%, #0d0804 100%) !important;
    ...
    body {
        background: radial-gradient(ellipse at 50% 0%, #fdfbf7 0%, #f7efe1 50%, #eee1ca 100%);
        color: var(--text-dark);
    ...
    .theme-toggle-btn {
        ...
        z-index: 99999;
        background: linear-gradient(135deg, var(--vintage-primary), var(--gold-primary));
        color: #fff;
    ...
    .btn-action-gold {
        background: linear-gradient(135deg, var(--vintage-primary) 0%, var(--gold-primary) 100%);
        color: #fff !important;
        font-size: clamp(15px, 3.2vw, 19px);
    ...
    .qr-header-badge {
        background: linear-gradient(135deg, var(--vintage-primary, #0f4c3a) 0%, #005f73 100%);
        color: #ffffff;
    ...
    .btn-view-qr-full {
        background: linear-gradient(135deg, var(--vintage-primary, #0f4c3a) 0%, #1e5a47 100%) !important;
        color: #ffffff !important;
    ...
    .countdown-value { font-size: clamp(24px, 5vw, 38px); font-weight: 800; color: var(--vintage-primary); }
    ...
    .timeline-badge {
        ...
        background: #ffffff; border: 3px solid var(--gold-primary); color: var(--vintage-primary);
    ...
    .timeline-content {
        ...
        border: 1px solid rgba(212, 175, 55, 0.4); border-left: 5px solid var(--vintage-primary);
    }
    ...
    .calendar-table th { background: var(--vintage-primary); color: #fff; padding: clamp(8px, 1.5vw, 14px) 4px; border-radius: 10px; font-size: clamp(11px, 2vw, 14px); }
...
<button class="theme-toggle-btn" id="themeToggleBtn">
    ...
    <span id="themeText">Vintage Elegance</span>
</button>
...
<div id="envelopeOverlay">
    <div class="envelope-card text-center position-relative">
        ...
        <p class="royal-subtitle">Vintage Antique Baroque Celebration</p>
...
<div class="container px-2 px-md-4 my-3 main-container">
    ...
    <!-- 1. Vintage Elegance & Gold Card Frame -->
    <div class="floral-card text-center" id="sec-home">
        ...
        <div class="gold-inner-frame">
            ...
            <div class="fade-in-up">
                ...
                <p class="text-uppercase font-weight-bold mb-3" style="letter-spacing: 2px; color: var(--gold-primary); font-size: clamp(15px, 3.5vw, 20px);">Vintage Antique Baroque Celebration</p>
            </div>
    ...
    <div class="card floral-card p-4 fade-in-up text-center">
        <h4 class="muol mb-3" style="color: var(--vintage-primary); font-size: clamp(23px, 4.8vw, 30px);"><i class="fas fa-user-check me-2"></i>ការឆ្លើយតបការចូលរួម (RSVP)</h4>
    ...
    <div class="card floral-card p-3 p-md-5">
        ...
        <div class="day-schedule-block mb-5">
            <div class="day-schedule-header text-center mb-4">
                <div class="d-inline-flex align-items-center gap-2 px-3 px-md-4 py-2 rounded-pill shadow-sm" style="background: linear-gradient(135deg, var(--vintage-primary, #1b4d3e) 0%, var(--gold-primary, #d4af37) 100%); color: #ffffff;">
            ...
            <div class="timeline">
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">02:00 PM</div>
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">03:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">05:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
        ...
        <div class="day-schedule-block">
            ...
            <div class="timeline">
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">06:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">07:00 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">07:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">08:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">09:15 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">11:00 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--vintage-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">12:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
            ...
            <div class="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
                <div class="modal-header border-0 pb-0 justify-content-between align-items-center p-3 p-md-4" style="background: linear-gradient(135deg, rgba(212,175,55,0.15) 0%, rgba(15,76,58,0.1) 100%);">
                    <h5 class="modal-title muol fs-4 text-dark mb-0" id="qrGiftModalLabel">
                        <i class="fas fa-qrcode me-2" style="color: var(--vintage-primary);"></i>ចំណងដៃអាពាហ៍ពិពាហ៍
                    </h5>
                ...
                <div class="modal-body text-center p-3 p-md-4">
                    ...
                    <div class="bg-light p-3 rounded-4 border mb-3 text-center shadow-sm">
                        ...
                        <strong class="muol text-dark d-block mb-2" style="font-size: clamp(17px, 3.5vw, 20px); color: var(--vintage-primary) !important;">RAN RA & KHOM SREYNET</strong>
                    ...
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        <button class="btn btn-success rounded-pill px-4 py-2.5 fw-bold text-white shadow-sm" id="btnCopyAccModal" style="background-color: var(--vintage-primary); border: none;">
            ...
            <div class="modal-content rounded-4 border-0 shadow-lg" style="background: var(--card-bg);">
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-3">
                        ...
                        <p class="text-muted mb-0" style="font-size: clamp(15px, 3vw, 18px);">ពិធីសិរីមង្គលអាពាហ៍ពិពាហ៍ (Vintage Antique Baroque Celebration)</p>
    ...
    <div class="card floral-card p-3 p-md-5 fade-in-up" id="sec-wishes">
        <h3 class="text-center muol text-dark mb-3" style="font-size: clamp(24px, 5vw, 32px);"><i class="fas fa-heart me-2" style="color: var(--vintage-primary);"></i>សារជូនពរជ័យ</h3>
        ...
        <div id="wishesList" class="mt-4">
            <div class="wish-card">
                <div class="d-flex justify-content-between align-items-center">
                    <strong class="muol text-dark" style="font-size: clamp(17.5px, 3.5vw, 21px);"><i class="fas fa-user-circle me-2" style="color: var(--vintage-primary);"></i>សម្លាញ់ ធាសុធី</strong>
                    <div class="d-flex align-items-center gap-2">
                        <small class="text-muted"><i class="far fa-clock me-1"></i>ទើបតែផ្ញើ</small>
                        <button class="like-btn" onclick="toggleLike(this)"><i class="fas fa-heart me-1" style="color: var(--vintage-primary);"></i><span class="like-count">24</span></button>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Theme Switcher Mode (Vintage Elegance vs Dark Midnight Emerald)
    ...
    if (themeToggleBtn) {
        themeToggleBtn.addEventListener('click', function () {
            ...
            if (isDark) {
                ...
                showToast('👑 ផ្លាស់ប្ដូរទៅជា Vintage Elegance Gold Theme!');
            }
        });
    }
    ...
    if (wishForm) {
        wishForm.addEventListener('submit', function (e) {
            ...
            card.innerHTML = `
                <div class="d-flex justify-content-between align-items-center">
                    <strong class="muol text-dark" style="font-size: clamp(14px, 2.5vw, 16px);"><i class="fas fa-user-circle me-2" style="color: var(--vintage-primary);"></i>${name}</strong>
                    <div class="d-flex align-items-center gap-2">
                        <small class="text-muted"><i class="far fa-clock me-1"></i>ទើបតែផ្ញើ</small>
                        <button class="like-btn" onclick="toggleLike(this)"><i class="fas fa-heart me-1" style="color: var(--vintage-primary);"></i><span class="like-count">1</span></button>
                    </div>
                </div>
