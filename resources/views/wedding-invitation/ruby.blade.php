...
<style>
    :root {
        ...
        --gold-accent: #c99c36;
        --cream-bg: #fdfaf7;
        --card-bg: rgba(255, 253, 250, 0.97);
        --card-shadow: 0 25px 65px rgba(128, 10, 40, 0.2), 0 10px 30px rgba(223, 184, 94, 0.25);
        --text-dark: #24070f;
    }

    /* Dark Midnight Ruby Theme Mode */
    body.dark-mode {
        --cream-bg: #140207;
        --card-bg: rgba(26, 4, 11, 0.96);
        --card-shadow: 0 28px 65px rgba(0, 0, 0, 0.88), 0 0 35px rgba(223, 184, 94, 0.25);
        --text-dark: #fcf4f6;
        background: radial-gradient(ellipse at 50% 0%, #2b0610 0%, #150207 60%, #080002 100%) !important;
    ...
    body.dark-mode .location-section-card {
        background-color: rgba(26, 4, 11, 0.96) !important;
    }
    body.dark-mode .date-box-num {
        color: #dfb85e !important;
    }
    body.dark-mode .timeline-content,
    body.dark-mode .wish-card,
    body.dark-mode .calendar-table,
    body.dark-mode .calendar-table td {
        background: #21050e !important;
        color: #fcf4f6 !important;
        border-color: rgba(223, 184, 94, 0.5) !important;
    }

    body {
        background: radial-gradient(ellipse at 50% 0%, #fdfbf7 0%, #f7ece2 50%, #e8d5c4 100%);
        color: var(--text-dark);
    ...
    .butterfly-particle {
        ...
        filter: drop-shadow(0 4px 10px rgba(128, 10, 40, 0.5));
    }
    ...
    .flower-petal {
        ...
        filter: drop-shadow(0 2px 6px rgba(223, 184, 94, 0.4));
    }
    ...
    .floral-card {
        ...
        overflow: hidden;
        border: 2px solid rgba(223, 184, 94, 0.45);
    ...
    .gold-inner-frame {
        ...
        outline: 1px dashed rgba(223, 184, 94, 0.7);
        outline-offset: -8px;
        border-radius: 18px;
    ...
    .corner-floral-top-right {
        ...
        pointer-events: none;
        z-index: 1;
        filter: drop-shadow(0 6px 16px rgba(223, 184, 94, 0.4));
    }
    ...
    .ido-badge {
        ...
        align-items: center;
        gap: 6px;
        text-shadow: 0 2px 10px rgba(223, 184, 94, 0.3);
    }
    ...
    .kissing-doves-wrapper {
        ...
        filter: drop-shadow(0 4px 12px rgba(223, 184, 94, 0.4));
    }
    ...
    .couple-name-title {
        ...
        text-shadow: 0 3px 10px rgba(128, 10, 40, 0.15);
        padding: 2px 0;
    }
    body.dark-mode .couple-name-title {
        color: var(--gold-accent);
        text-shadow: 0 3px 10px rgba(223, 184, 94, 0.3);
    }
    ...
    .couple-ampersand {
        ...
        color: var(--gold-primary);
        margin: 18px 8px 0;
        text-shadow: 0 2px 8px rgba(223, 184, 94, 0.3);
        align-self: center;
    }
    ...
    .graphic-flank-icon {
        ...
        filter: drop-shadow(0 4px 8px rgba(223, 184, 94, 0.4));
    }
    ...
    .reception-script {
        ...
        color: var(--gold-primary);
        margin-top: 22px;
        text-shadow: 0 2px 8px rgba(223, 184, 94, 0.2);
    }
    ...
    #actionToast {
        ...
        z-index: 100000;
        background: linear-gradient(135deg, #800a28, #4d0517);
    ...
    /* Envelope Opening Startup Screen Overlay */
        ...
        height: 100vh;
        height: 100dvh;
        background: radial-gradient(circle at center, #fdf8f5 0%, #edd8ce 100%);
        z-index: 99999;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    .envelope-card {
        ...
        outline: 1px dashed rgba(223, 184, 94, 0.8);
        outline-offset: -7px;
        border-radius: 32px;
        padding: clamp(28px, 6vw, 52px) clamp(20px, 4vw, 42px);
        max-width: 530px;
        width: min(92vw, 530px);
        box-shadow: 0 32px 75px rgba(0,0,0,0.25), 0 0 30px rgba(128, 10, 40, 0.2);
        text-align: center;
        position: relative;
    ...
    .envelope-wax-seal {
        ...
        background: linear-gradient(135deg, #800a28, #dfb85e);
        color: #fff;
        border-radius: 50%;
        display: flex;
        align-items: center;
        ...
        margin: 0 auto 15px;
        box-shadow: 0 8px 20px rgba(128, 10, 40, 0.4), inset 0 2px 4px rgba(255,255,255,0.6);
    ...
    /* Action Ruby & Gold Button */
    .btn-action-gold {
        background: linear-gradient(135deg, var(--ruby-primary) 0%, var(--gold-primary) 100%);
        color: #fff !important;
        font-size: clamp(15px, 3.2vw, 19px);
        padding: clamp(12px, 2.5vw, 15px) clamp(24px, 5vw, 42px);
        border-radius: 50px;
        border: 2px solid var(--gold-light);
        box-shadow: 0 10px 25px rgba(128, 10, 40, 0.35);
        cursor: pointer;
        transition: all 0.35s ease;
    ...
    @keyframes pulseBtn {
        0%, 100% { box-shadow: 0 10px 25px rgba(128, 10, 40, 0.35); }
        50% { box-shadow: 0 14px 32px rgba(223, 184, 94, 0.55); transform: scale(1.02); }
    }
    ...
    .location-preview-img:hover {
        ...
        box-shadow: 0 20px 42px rgba(223, 184, 94, 0.4);
    }
    ...
    .qr-header-badge {
        background: linear-gradient(135deg, var(--ruby-primary, #800020) 0%, #990000 100%);
        color: #ffffff;
    ...
    .btn-view-qr-full {
        background: linear-gradient(135deg, var(--ruby-primary, #800020) 0%, #a30029 100%) !important;
        color: #ffffff !important;
    ...
    .btn-view-qr-full:hover {
        ...
        box-shadow: 0 10px 25px rgba(128, 0, 32, 0.45) !important;
    }

    .btn-view-qr-full {
        background: linear-gradient(135deg, var(--ruby-primary) 0%, var(--gold-primary) 100%) !important;
        color: #ffffff !important;
        border: none !important;
        border-radius: 50px !important;
        ...
        font-size: 14px !important;
        box-shadow: 0 8px 22px rgba(128, 10, 40, 0.35) !important;
        transition: all 0.3s ease !important;
    }
    .btn-view-qr-full:hover {
        transform: scale(1.05) translateY(-2px) !important;
        box-shadow: 0 12px 28px rgba(223, 184, 94, 0.5) !important;
    }
    ...
    .countdown-box {
        ...
        box-shadow: 0 12px 24px rgba(223, 184, 94, 0.25);
        text-align: center;
        flex: 1;
        max-width: 130px;
    }

    .countdown-value { font-size: clamp(24px, 5vw, 38px); font-weight: 800; color: var(--ruby-primary); }
    ...
    .timeline-badge {
        ...
        background: #ffffff; border: 3px solid var(--gold-primary); color: var(--ruby-primary);
    ...
    .timeline-content {
        ...
        border: 1px solid rgba(223, 184, 94, 0.4); border-left: 5px solid var(--ruby-primary);
    }
    ...
    .calendar-table th { background: var(--ruby-primary); color: #fff; padding: clamp(8px, 1.5vw, 14px) 4px; border-radius: 10px; font-size: clamp(11px, 2vw, 14px); }
    ...
    .wish-card {
        ...
        border-radius: 18px;
        padding: 18px 24px;
        border: 1px solid rgba(223, 184, 94, 0.35);
...
<button class="theme-toggle-btn" id="themeToggleBtn">
    <i class="fas fa-wine-glass-alt" id="themeIcon"></i>
    <span id="themeText">Ruby Velvet</span>
</button>
...
<div id="envelopeOverlay">
    <div class="envelope-card text-center position-relative">
        ...
        <p class="royal-subtitle">Ruby Velvet Wedding</p>
...
<div class="container px-2 px-md-4 my-3 main-container">
    ...
    <div class="card location-section-card text-center fade-in-up" id="sec-location">
        <div class="mb-1" style="font-size: 26px;">🌿 🌹 🌿</div>
        ...
        <p class="text-secondary mb-4" style="line-height: 1.7; font-size: clamp(17px, 3.5vw, 22px);">
    ...
    <div class="card floral-card p-4 fade-in-up text-center">
        <h4 class="muol mb-3" style="color: var(--ruby-primary); font-size: clamp(22px, 4.5vw, 28px);"><i class="fas fa-user-check me-2"></i>ការឆ្លើយតបការចូលរួម (RSVP)</h4>
        <div class="d-flex justify-content-center gap-2 gap-md-3 flex-wrap">
            <button class="btn btn-outline-danger rounded-pill px-3 px-md-4 py-2 fw-bold" id="btnRsvpYes" style="font-size: clamp(16px, 3.2vw, 19px); color: var(--ruby-primary); border-color: var(--ruby-primary);">
                <i class="fas fa-check-circle me-1"></i>នឹងចូលរួម (Attending)
            </button>
            <button class="btn btn-outline-secondary rounded-pill px-3 px-md-4 py-2 fw-bold" id="btnRsvpNo" style="font-size: clamp(16px, 3.2vw, 19px);">
    ...
    <div class="card floral-card p-3 p-md-5 fade-in-up text-center" id="sec-calendar">
        <h3 class="muol text-dark mb-3" style="font-size: clamp(24px, 5vw, 32px);">រាប់ថយក្រោយដល់ថ្ងៃសិរីមង្គល</h3>
    ...
    <div class="card floral-card p-3 p-md-5">
        ...
        <div class="day-schedule-block mb-5">
            <div class="day-schedule-header text-center mb-4">
                <div class="d-inline-flex align-items-center gap-2 px-3 px-md-4 py-2 rounded-pill shadow-sm" style="background: linear-gradient(135deg, var(--ruby-primary, #900c3f) 0%, var(--gold-primary, #d4af37) 100%); color: #ffffff;">
            ...
            <div class="timeline">
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">02:00 PM</div>
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">03:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">05:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
        ...
        <div class="day-schedule-block">
            ...
            <div class="timeline">
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">06:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">07:00 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">07:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">08:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">09:15 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">11:00 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--ruby-primary, #900c3f); font-size: clamp(16px, 3.2vw, 19.5px);">12:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
    ...
    <div class="modal fade" id="qrGiftModal" tabindex="-1" aria-labelledby="qrGiftModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
                <div class="modal-header border-0 pb-0 justify-content-between align-items-center p-3 p-md-4" style="background: linear-gradient(135deg, rgba(128,0,32,0.12) 0%, rgba(212,175,55,0.1) 100%);">
                    <h5 class="modal-title muol fs-4 text-dark mb-0" id="qrGiftModalLabel">
                        <i class="fas fa-qrcode me-2" style="color: var(--ruby-primary);"></i>ចំណងដៃអាពាហ៍ពិពាហ៍
                    </h5>
                ...
                <div class="modal-body text-center p-3 p-md-4">
                    ...
                    <div class="bg-light p-3 rounded-4 border mb-3 text-center shadow-sm">
                        ...
                        <strong class="muol text-dark d-block mb-2" style="font-size: clamp(17px, 3.5vw, 20px); color: var(--ruby-primary) !important;">RAN RA & KHOM SREYNET</strong>
                    ...
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        <button class="btn btn-danger rounded-pill px-4 py-2.5 fw-bold text-white shadow-sm" id="btnCopyAccModal" style="background-color: var(--ruby-primary); border: none;">
    ...
    <div class="card floral-card p-3 p-md-5 fade-in-up" id="sec-wishes">
        <h3 class="text-center muol text-dark mb-3" style="font-size: clamp(24px, 5vw, 32px);"><i class="fas fa-heart me-2" style="color: var(--ruby-primary);"></i>សារជូនពរជ័យ</h3>
        <p class="text-center text-muted mb-4" style="font-size: clamp(16px, 3vw, 19px);">សូមបញ្ជូនសារជូនពរ និងពាក្យពេចន៍ល្អៗជូនដល់គូស្វាមីភរិយាថ្មី</p>

        <form id="wishForm" class="mb-4">
            <div class="row g-3">
                <div class="col-md-5">
                    <input type="text" id="wishName" class="form-control form-control-lg border-danger shadow-sm rounded-3" placeholder="ឈ្មោះរបស់អ្នក (Your Name)" value="{{ $guestName !== 'សម្លាញ់ ធាសុធី' ? $guestName : '' }}" required style="font-size: clamp(16px, 3.2vw, 19px);">
                </div>
                <div class="col-md-7">
                    <input type="text" id="wishMessage" class="form-control form-control-lg border-danger shadow-sm rounded-3" placeholder="សារជូនពរ (Your Wish)" required style="font-size: clamp(16px, 3.2vw, 19px);">
                </div>
        ...
        <div id="wishesList" class="mt-4">
            <div class="wish-card">
                <div class="d-flex justify-content-between align-items-center">
                    <strong class="muol text-dark" style="font-size: clamp(17px, 3.2vw, 20px);"><i class="fas fa-user-circle me-2" style="color: var(--ruby-primary);"></i>សម្លាញ់ ធាសុធី</strong>
                    <div class="d-flex align-items-center gap-2">
                        <small class="text-muted"><i class="far fa-clock me-1"></i>ទើបតែផ្ញើ</small>
                        <button class="like-btn" onclick="toggleLike(this)"><i class="fas fa-heart me-1" style="color: var(--ruby-primary);"></i><span class="like-count">24</span></button>
                    </div>
                </div>
                <p class="text-secondary mb-0 mt-2" style="font-size: clamp(16px, 3vw, 18px);">សូមជូនពរមិត្តទាំងពីរជួបតែសេចក្ដីសុខ សុភមង្គល និងស្រឡាញ់គ្នារហូតដល់ចាស់កោងខ្នង!</p>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Theme Switcher Mode (Ruby Velvet vs Dark Midnight Ruby)
    ...
    if (themeToggleBtn) {
        themeToggleBtn.addEventListener('click', function () {
            ...
            if (isDark) {
                ...
                showToast('🌙 ផ្លាស់ប្ដូរទៅជា Dark Midnight Ruby Theme!');
            } else {
                document.body.classList.remove('dark-mode');
                showToast('🌹 ផ្លាស់ប្ដូរទៅជា Ruby Velvet Gold Theme!');
            }
        });
    }
    ...
    if (wishForm) {
        wishForm.addEventListener('submit', function (e) {
            ...
            card.innerHTML = `
                <div class="d-flex justify-content-between align-items-center">
                    <strong class="muol text-dark" style="font-size: clamp(17px, 3.2vw, 20px);"><i class="fas fa-user-circle me-2" style="color: var(--ruby-primary);"></i>${name}</strong>
                    <div class="d-flex align-items-center gap-2">
                        <small class="text-muted"><i class="far fa-clock me-1"></i>ទើបតែផ្ញើ</small>
                        <button class="like-btn" onclick="toggleLike(this)"><i class="fas fa-heart me-1" style="color: var(--ruby-primary);"><span class="like-count">1</span></button>
                    </div>
                </div>
                <p class="text-secondary mb-0 mt-2" style="font-size: clamp(16px, 3vw, 18px);">${msg}</p>
            `;
...
</script>       musicBtn.addEventListener('click', function () {
            if (isPlaying) {
                audio.pause();
                if (musicWidget) musicWidget.classList.remove('playing');
                if (musicIcon) musicIcon.className = 'fas fa-music';
    ...
    if (wishForm) {
        wishForm.addEventListener('submit', function (e) {
            ...
            card.innerHTML = `
                <div class="d-flex justify-content-between align-items-center">
                    <strong class="muol text-dark" style="font-size: clamp(14px, 2.5vw, 16px);"><i class="fas fa-user-circle me-2" style="color: var(--ruby-primary);"></i>${name}</strong>
                    <div class="d-flex align-items-center gap-2">
                        <small class="text-muted"><i class="far fa-clock me-1"></i>ទើបតែផ្ញើ</small>
                        <button class="like-btn" onclick="toggleLike(this)"><i class="fas fa-heart me-1" style="color: var(--ruby-primary);"><span class="like-count">1</span></button>
                    </div>
