...
<style>
    :root {
        --lavender-primary: #6f42c1;
        --theme-dark: #381970;
        --gold-primary: #dfb85e;
        --gold-light: #f3e8ff;
        --gold-accent: #c084fc;
        --cream-bg: #faf7ff;
        --card-bg: rgba(253, 251, 255, 0.98);
        --card-shadow: 0 25px 65px rgba(111, 66, 193, 0.18), 0 10px 30px rgba(223, 184, 94, 0.22);
        --text-dark: #1e1035;
        --rose-accent: #c84b68;
    }
    ...
    body.dark-mode {
        --cream-bg: #120722;
        --card-bg: rgba(32, 15, 59, 0.97);
        --text-dark: #f3e8ff;
        background: radial-gradient(ellipse at 50% 0%, #260f47 0%, #130724 60%, #090312 100%) !important;
        color: #f3e8ff !important;
        --card-bg: rgba(10, 31, 24, 0.96);
        --card-shadow: 0 28px 65px rgba(0, 0, 0, 0.8), 0 0 35px rgba(212, 175, 55, 0.25);
        --text-dark: #f5f0e6;
        background: radial-gradient(ellipse at 50% 0%, #0d2c22 0%, #061812 60%, #020b08 100%) !important;
    ...
    body.dark-mode .location-section-card {
        background-color: rgba(10, 31, 24, 0.96) !important;
    }
    ...
    body.dark-mode .calendar-table td {
        background: #1b0d33 !important;
        color: #f5f0e6 !important;
        border-color: rgba(212, 175, 55, 0.5) !important;
    }

    body {
        background: radial-gradient(ellipse at 50% 0%, #fbf9ff 0%, #f3e8ff 50%, #e9d5ff 100%);
        color: var(--text-dark);
    ...
    .floating-particles-canvas, #flowerCanvas {
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
    ...
    .couple-name-title {
        ...
        text-shadow: 0 3px 10px rgba(15, 76, 58, 0.15);
        padding: 2px 0;
    }
    ...
    .theme-toggle-btn {
        ...
        z-index: 99999;
        background: linear-gradient(135deg, var(--lavender-primary), var(--gold-primary));
        color: #fff;
    ...
    #actionToast {
        ...
        z-index: 100000;
        background: linear-gradient(135deg, #0f4c3a, #072a20);
    ...
    /* Envelope Opening Startup Screen Overlay */
        ...
        height: 100vh;
        height: 100dvh;
        background: radial-gradient(circle at center, #fdfaf3 0%, #e6d7b5 100%);
        z-index: 99999;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    .envelope-card {
        ...
        box-shadow: 0 32px 75px rgba(0,0,0,0.25), 0 0 30px rgba(212, 175, 55, 0.2);
        text-align: center;
        position: relative;
    ...
    #envelopeOverlay {
        background: radial-gradient(circle at 50% 42%, #fffdf7 0%, #f5ead0 62%, #ead9b2 100%);
    ...
    .envelope-wax-seal {
        ...
        background: linear-gradient(135deg, #d4af37, #997815);
        color: #fff;
        border-radius: 50%;
        display: flex;
        align-items: center;
        ...
        margin: 0 auto 15px;
        box-shadow: 0 8px 20px rgba(153, 120, 21, 0.4), inset 0 2px 4px rgba(255,255,255,0.6);
    ...
    /* Action Emerald & Gold Button */
    .btn-action-gold {
        background: linear-gradient(135deg, var(--lavender-primary) 0%, var(--gold-primary) 100%);
        color: #fff !important;
        font-size: clamp(15px, 3.2vw, 19px);
        padding: clamp(12px, 2.5vw, 15px) clamp(24px, 5vw, 42px);
        border-radius: 50px;
        border: 2px solid var(--gold-light);
        box-shadow: 0 10px 25px rgba(15, 76, 58, 0.35);
        cursor: pointer;
        transition: all 0.35s ease;
    ...
    @keyframes pulseBtn {
        0%, 100% { box-shadow: 0 10px 25px rgba(15, 76, 58, 0.35); }
    ...
    .qr-header-badge {
        background: linear-gradient(135deg, var(--lavender-primary, #0f4c3a) 0%, #005f73 100%);
        color: #ffffff;
    ...
    .btn-view-qr-full {
        background: linear-gradient(135deg, var(--lavender-primary, #0f4c3a) 0%, #1e5a47 100%) !important;
        color: #ffffff !important;
        ...
        font-weight: 700 !important;
        font-size: 14px !important;
        box-shadow: 0 6px 20px rgba(15, 76, 58, 0.3) !important;
        transition: all 0.3s ease !important;
    }
    .btn-view-qr-full:hover {
        transform: scale(1.04) translateY(-2px) !important;
        box-shadow: 0 10px 25px rgba(15, 76, 58, 0.45) !important;
    }
    ...
    .countdown-value { font-size: clamp(24px, 5vw, 38px); font-weight: 800; color: var(--lavender-primary); }
    ...
    .timeline-badge {
        ...
        background: #ffffff; border: 3px solid var(--gold-primary); color: var(--lavender-primary);
    ...
    .timeline-content {
        ...
        border: 1px solid rgba(212, 175, 55, 0.4); border-left: 5px solid var(--lavender-primary);
    }
    ...
    .calendar-table th { background: var(--lavender-primary); color: #fff; padding: clamp(8px, 1.5vw, 14px) 4px; border-radius: 10px; font-size: clamp(11px, 2vw, 14px); }
...
<button class="theme-toggle-btn" id="themeToggleBtn">
    <i class="fas fa-crown" id="themeIcon"></i>
    <span id="themeText">Lavender Dream</span>
</button>
...
<div id="envelopeOverlay">
    <div class="envelope-card text-center position-relative">
        ...
        <p class="royal-subtitle">Starlight Lavender Dream Wedding</p>
...
<div class="container px-2 px-md-4 my-3 main-container">
    ...
    <!-- 1. Lavender Dream & Gold Card Frame -->
    <div class="floral-card text-center" id="sec-home">
        ...
        <div class="gold-inner-frame">
            ...
            <div class="fade-in-up">
                ...
                <p class="text-uppercase font-weight-bold mb-3" style="letter-spacing: 2px; color: var(--gold-primary); font-size: clamp(15px, 3.5vw, 20px);">Starlight Lavender Dream Wedding</p>
            </div>
    ...
    <div class="card location-section-card text-center fade-in-up" id="sec-location">
        ...
        <p class="text-secondary mb-4" style="line-height: 1.8; font-size: clamp(17px, 3.5vw, 21px);">
            {{ isset($wedding) && ($wedding->venue_name || $wedding->venue_address) ? ($wedding->venue_name . ' - ' . $wedding->venue_address) : 'ស្ថិតនៅគេហដ្ឋានខាងស្រី ភូមិព្រៃខ្លាទី១ ឃុំព្រៃខ្លា ស្រុកស្វាយអន្ទរ ខេត្តព្រៃវែង' }}
        </p>

        <div class="my-3">
            <img src="{{ asset('assets/images/Location.png') }}" class="location-preview-img img-fluid" alt="Map Location Preview" onclick="window.open('{{ isset($wedding) && $wedding->venue_location_url ? $wedding->venue_location_url : 'https://maps.app.goo.gl/mB65Fwu3L9natdqr6' }}', '_blank')">
        </div>

        <div class="mt-4">
            <a href="{{ isset($wedding) && $wedding->venue_location_url ? $wedding->venue_location_url : 'https://maps.app.goo.gl/mB65Fwu3L9natdqr6' }}" target="_blank" class="btn btn-action-gold text-decoration-none">
    ...
    <div class="card floral-card p-4 fade-in-up text-center">
        <h4 class="muol mb-3" style="color: var(--lavender-primary); font-size: clamp(23px, 4.8vw, 30px);"><i class="fas fa-user-check me-2"></i>ការឆ្លើយតបការចូលរួម (RSVP)</h4>
    ...
    <div class="card floral-card p-3 p-md-5">
        ...
        <div class="day-schedule-block mb-5">
            <div class="day-schedule-header text-center mb-4">
                <div class="d-inline-flex align-items-center gap-2 px-3 px-md-4 py-2 rounded-pill shadow-sm" style="background: linear-gradient(135deg, var(--lavender-primary, #1b4d3e) 0%, var(--gold-primary, #d4af37) 100%); color: #ffffff;">
            ...
            <div class="timeline">
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">02:00 PM</div>
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">03:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">05:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
        ...
        <div class="day-schedule-block">
            ...
            <div class="timeline">
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">06:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">07:00 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">07:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">08:30 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">09:15 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">11:00 AM</div>
                    <div class="col-2 col-md-1 text-center">
                ...
                <div class="row align-items-center timeline-item fade-in-up mb-3">
                    <div class="col-3 col-md-2 text-center text-md-end fw-bold" style="color: var(--lavender-primary, #1b4d3e); font-size: clamp(16px, 3.2vw, 19.5px);">12:00 PM</div>
                    <div class="col-2 col-md-1 text-center">
                        ...
                        <tr>
                            @for($c = 0; $c < 7; $c++)
                                ...
                                @elseif($currDay > $totalDays)
                                    <td></td>
                                @else
                                    <td class="{{ $weddingDateObj->day == $currDay ? 'wedding-day' : '' }}" onclick="selectCalendarDate(this, {{ $currDay }})" title="ចុចដើម្បីរក្សាទុកក្នុងប្រតិទិន">
                                        {{ $currDay }}
                                    </td>
                                    @php $currDay++; @endphp
                                @endif
    ...
    <div class="card gallery-section-card p-2 p-md-4 fade-in-up text-center" id="sec-gallery">
        <div class="gallery-bg-pattern">
            <div class="mb-1" style="font-size: 28px;">🌸 ⚜️ 🏵️</div>
    ...
    <div class="modal fade" id="qrGiftModal" tabindex="-1" aria-labelledby="qrGiftModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
                <div class="modal-header border-0 pb-0 justify-content-between align-items-center p-3 p-md-4" style="background: linear-gradient(135deg, rgba(212,175,55,0.15) 0%, rgba(15,76,58,0.1) 100%);">
                    <h5 class="modal-title muol fs-4 text-dark mb-0" id="qrGiftModalLabel">
                        <i class="fas fa-qrcode me-2" style="color: var(--lavender-primary);"></i>ចំណងដៃអាពាហ៍ពិពាហ៍
                    </h5>
                ...
                <div class="modal-body text-center p-3 p-md-4">
                    ...
                    <div class="p-3 bg-white rounded-4 d-inline-block border border-success border-opacity-50 shadow-sm mb-3" onclick="copyAccNum(event);" style="max-width: 320px; cursor: pointer;" title="ចុចដើម្បីចម្លងលេខគណនី">
                    ...
                    <div class="bg-light p-3 rounded-4 border mb-3 text-center shadow-sm">
                        ...
                        <strong class="muol text-dark d-block mb-2" style="font-size: clamp(17px, 3.5vw, 20px); color: var(--lavender-primary) !important;">RAN RA & KHOM SREYNET</strong>
                    ...
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        <button class="btn btn-success rounded-pill px-4 py-2.5 fw-bold text-white shadow-sm" id="btnCopyAccModal" style="background-color: var(--lavender-primary); border: none;">
            ...
            <div class="modal-content rounded-4 border-0 shadow-lg" style="background: var(--card-bg);">
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-3">
                        ...
                        <p class="text-muted mb-0" style="font-size: clamp(15px, 3vw, 18px);">ពិធីសិរីមង្គលអាពាហ៍ពិពាហ៍ (Starlight Lavender Dream Wedding)</p>
    ...
    <div class="card floral-card p-3 p-md-5 fade-in-up" id="sec-wishes">
        <h3 class="text-center muol text-dark mb-3" style="font-size: clamp(24px, 5vw, 32px);"><i class="fas fa-heart me-2" style="color: var(--lavender-primary);"></i>សារជូនពរជ័យ</h3>
        ...
        <form id="wishForm" class="mb-4">
            <div class="row g-3">
                <div class="col-md-5">
                    <input type="text" id="wishName" class="form-control form-control-lg border-success shadow-sm rounded-3" placeholder="ឈ្មោះរបស់អ្នក (Your Name)" value="{{ $guestName !== 'សម្លាញ់ ធាសុធី' ? $guestName : '' }}" required style="font-size: clamp(17px, 3.5vw, 20px);">
                </div>
                <div class="col-md-7">
                    <input type="text" id="wishMessage" class="form-control form-control-lg border-success shadow-sm rounded-3" placeholder="សារជូនពរ (Your Wish)" required style="font-size: clamp(17px, 3.5vw, 20px);">
                </div>
        ...
        <div id="wishesList" class="mt-4">
            <div class="wish-card">
                <div class="d-flex justify-content-between align-items-center">
                    <strong class="muol text-dark" style="font-size: clamp(17.5px, 3.5vw, 21px);"><i class="fas fa-user-circle me-2" style="color: var(--lavender-primary);"></i>សម្លាញ់ ធាសុធី</strong>
                    <div class="d-flex align-items-center gap-2">
                        <small class="text-muted"><i class="far fa-clock me-1"></i>ទើបតែផ្ញើ</small>
                        <button class="like-btn" onclick="toggleLike(this)"><i class="fas fa-heart me-1" style="color: var(--lavender-primary);"></i><span class="like-count">24</span></button>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Theme Switcher Mode (Lavender Dream vs Dark Midnight Emerald)
    ...
    if (themeToggleBtn) {
        themeToggleBtn.addEventListener('click', function () {
            ...
            if (isDark) {
                ...
                showToast('🌙 ផ្លាស់ប្ដូរទៅជា Dark Midnight Emerald Theme!');
            } else {
                document.body.classList.remove('dark-mode');
                showToast('👑 ផ្លាស់ប្ដូរទៅជា Lavender Dream Gold Theme!');
            }
        });
    }
    ...
    if (wishForm) {
        wishForm.addEventListener('submit', function (e) {
            ...
            card.innerHTML = `
                <div class="d-flex justify-content-between align-items-center">
                    <strong class="muol text-dark" style="font-size: clamp(14px, 2.5vw, 16px);"><i class="fas fa-user-circle me-2" style="color: var(--lavender-primary);"></i>${name}</strong>
                    <div class="d-flex align-items-center gap-2">
                        <small class="text-muted"><i class="far fa-clock me-1"></i>ទើបតែផ្ញើ</small>
                        <button class="like-btn" onclick="toggleLike(this)"><i class="fas fa-heart me-1" style="color: var(--lavender-primary);"></i><span class="like-count">1</span></button>
                    </div>
                </div>
