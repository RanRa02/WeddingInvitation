...
<div class="container-fluid px-0">
    <div class="card sub-content">
        <div class="card-body text-center mt-4">
            ...
            <div class="fade-in-up mt-4" style="animation-delay:.9s">
                ...
                <div class="name-frame-wrapper mt-2">
                    ...
                    <div class="name-frame-text muol">
                        <span class="name" style="font-size: 25px; text-shadow:2px 2px 2px 2px #000;">{{ $data['nickname'] ?? '' }}</span>
                    </div>
                </div>
            </div>
            ...
            <h3 class="text-center mb-3 name muol">ថ្ងៃអាទិត្យ ទី១៨ ខែមករា ឆ្នាំ២០២៦ វេលាម៉ោង ៨៖០០ ព្រឹក</h3>
            <h3 class="text-center mb-3 name muol">ស្ថិតនៅគេហដ្ឋានខាងស្រី ភូមិវាល ឃុំព្រៃខ្លា ស្រុកស្វាយអន្ទរ ខេត្តព្រៃវែង</h3>
            </div>
    ...
    <div class="card sub-content-two p-3 p-md-4 mt-4">
        ...
        <div class="fade-in-up mt-4" style="animation-delay:1.8s">
            ...
            <p class="text-muted text-center" style="font-size: 20px;">
                ...
                និងជាភ្ញៀវកិត្តិយស ដើម្បីប្រសិទ្ធិពរជ័យសិរីសួស្តី ជ័យមង្គល ក្នុងពិធីសិរីមង្គលពិធីភ្ជាប់ពាក្យ របស់កូនប្រុស
                រ៉ាន់ រ៉ា និងកូនស្រី ខុម ស្រីណេត ដែលនឹងប្រព្រឹត្តទៅនៅថ្ងៃទី ១៨ ខែមករា ឆ្នាំ ២០២៦ វេលាម៉ោង ៨៖០០ ព្រឹក
                ស្ថិតនៅគេហដ្ឋានខាងស្រី ភូមិវាល ឃុំព្រៃខ្លា ស្រុកស្វាយអន្ទរ ខេត្តព្រៃវែង។
            </p>
        </div>
    </div>
